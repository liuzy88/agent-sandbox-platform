...
import { createTool, deleteTool } from "../../api/tools.ts";
import { listOpenApiOperations } from "../../api/resources.ts";
import { pasteOpenApi } from "../../api/resources.ts";
...
interface OpenApiPanelProps {
  tools: import("../../api/types.ts").Tool[];
  readySpecs: Resource[];
